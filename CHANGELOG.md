...
- **REWRITTEN — `src/pages/en/modules/04-robotique/index.astro`** (~850 lignes) : Module 4 entièrement traduit en anglais. 11 sections complètes : Executive summary (mature technology, two ruptures cobots+AI, three axes for the leader), Learning objectives, Key concepts (5 ConceptCards : Three robotic families for three use cases, Perception planning and control - the three pillars, Human-machine safety and normative framework, The real total cost of a robotics project, Economic and social framing), Common errors (4 PitfallList items : comparing prices without total cost, confusing standalone vs collaborative, underestimating HR/social/legal stakes, neglecting maintenance and run), Real case Amazon Robotics + DeepFleet + mini-cas Universal Robots et la robotique pour PME, Practical activity (4 steps), Formative quiz (interactive React island avec quizModule4EN), Manager checklist (12 points en 3 groupes : Technical project framing / Safety standards and compliance / Economy and social), Application in your organization (5 questions + aside consultants), Key takeaways, Going further (6 ressources). Build validé : 98 pages, 0 erreur Astro check sur 145 fichiers (+1 vs précédent = quiz module-4-en.ts ajouté). Contenu EN rendu correctement (Amazon Robotics 6x, Universal Robots 4x, ISO/TS 15066 12x, DeepFleet 3x).
...
- **REWRITTEN — `src/pages/en/modules/03-ia-generative/index.astro`** (~820 lignes) : Module 3 entièrement traduit en anglais. 11 sections complètes : Executive summary (foundation models, hallucinations, total cost), Learning objectives, Key concepts (5 ConceptCards : Foundation models and economics of GenAI, Prompting RAG and fine-tuning, Hallucinations and guardrails, Decompose the workflow rather than automate, The total cost of automation), Common errors (4 PitfallList items : mistaking plausible for true, underestimating total automation cost, mistaking demo for solution, breaking the internal training pipeline), Real case Morgan Stanley AskResearchGPT/Debrief + mini-cas GitHub Copilot × Accenture, Practical activity (4 steps), Formative quiz (interactive React island avec quizModule3EN), Manager checklist (12 points en 3 groupes : GenAI case framing / Guardrails and compliance / Economy and organization), Application in your organization (5 questions + aside consultants), Key takeaways, Going further (6 ressources).
- **NEW — `src/content/quizzes/module-2-en.ts`** (~150 lignes) : version anglaise du quiz Module 2. Mêmes 7 questions, mêmes options, mêmes correctIndex, mêmes scoring bands que le quiz FR — seul le contenu naturel est traduit. Suit le pattern établi par module-1-en.ts.
- **REWRITTEN — `src/pages/en/modules/02-machine-learning/index.astro`** (~810 lignes) : Module 2 entièrement traduit en anglais. 11 sections complètes : Executive summary, Learning objectives, Key concepts (5 ConceptCards : The three ML families, The four viability conditions, Overfitting and generalization, The model is just one layer of the system, Strategic framing of an ML use case), Common errors (4 PitfallList items : evaluating on accuracy not ROI, underestimating labeling cost, confusing correlation and causality, ignoring drift), Real case Stripe Radar + mini-cas Mirai (Regina Barzilay MIT CSAIL), Practical activity (4 steps), Formative quiz (interactive React island avec quizModule2EN), Manager checklist (12 points en 3 groupes : Technical case framing / Data and compliance / Strategy and governance), Application in your organization (5 questions + aside consultants), Key takeaways, Going further (6 ressources).
