...
- ~~Phase 4.7-4.8 : 10 études de cas (Morgan Stanley, Stripe, GitHub Copilot, Amazon, Klarna, Takeda, etc.).~~ **→ EN COURS : 6/10 cas publiés (Takeda CCI + Stripe Radar + Morgan Stanley + Amazon Robotics + GitHub × Accenture + Regina Barzilay)**, 4 restants en sous-tour final
